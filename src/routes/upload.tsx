...
export const Route = createFileRoute("/upload")({
  head: () => ({
    meta: [
      { title: "Bulk Resume Upload — ResumeIQ" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Bulk Resume Upload — ResumeIQ" },
      {
...
export function UploadPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <header>
        <h1 className="text-2xl font-extrabold sm:text-3xl">Bulk Resume Upload</h1>
