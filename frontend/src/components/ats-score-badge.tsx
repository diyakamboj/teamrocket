  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <div className="min-w-0 leading-tight">
        <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">ATS score</p>
        {!compact && (
          <div className="mt-0.5 flex flex-wrap items-center gap-1">
            <Badge className={cn("text-[10px] font-bold capitalize", atsToneClass(score))}>
              {atsTierLabel(score)}
            </Badge>
