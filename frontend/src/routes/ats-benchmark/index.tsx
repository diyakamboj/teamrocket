    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          A standard keyword-matching ATS baseline, with an LLM semantic evaluation layered on
          top — so you can see where the two disagree.
        </p>
      </header>
            ...
            <>
              ...
              {loadingBenchmark ? (
                <div className="flex items-center gap-2 py-16 text-sm text-muted-foreground">
                  <Loader2 className="h-4 w-4 animate-spin" /> Checking for an existing
                  benchmark…
                </div>
              ) : !benchmark ? (
