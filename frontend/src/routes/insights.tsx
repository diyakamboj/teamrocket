      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="card-surface p-6">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            The pool is strong on core fundamentals — {SKILL_DISTRIBUTION[0]!.count} candidates show{" "}
            {SKILL_DISTRIBUTION[0]!.skill} evidence and {seniorPlus} are senior or above. The
