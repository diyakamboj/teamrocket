  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <header className="card-surface flex flex-wrap items-center gap-4 p-6">
        {typeof sc.overall_score === "number" && <ScoreRing value={Math.round(sc.overall_score)} size={64} />}
      ...
      {(sc.skill_score != null ||
        ...
        <section className="card-surface grid gap-4 p-5 sm:grid-cols-2">
          ...
          {sc.project_score != null && <MiniBar label="Projects" value={Math.round(sc.project_score)} />}
        </section>
      )}
